...
public class TemplateController {
    ...
    public String hello() {
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/hello");
    ...
    public User user() {
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/user");
    ...
    public User getUser(@RequestParam("id") Integer id,
        ...
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/getUser");
    ...
    public User addUser(@RequestParam("id") Integer id,
        ...
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/addUser");
    ...
    public User addUser2(@RequestBody User user) {
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/addUser-->" + user.getId() + "--" + user.getName() + "--" + user.getPhone());
    ...
    public User updateUser(@RequestParam("id") Integer id,
        ...
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/updateUser--" + id + "--" + name + "--" + phone);
    ...
    public User deleteUser(@RequestParam("id") Integer id,
        ...
        //进行业务处理（省略）
        System.out.println("服务提供者2-->/service/deleteUser--" + id + "--" + name + "--" + phone);
